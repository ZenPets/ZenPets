...
import biz.zenpets.trainers.details.modules.TrainingGalleryActivity;
import biz.zenpets.trainers.utils.models.trainers.modules.ModuleImage;

public class TrainingModuleImagesAdapter extends RecyclerView.Adapter<TrainingModuleImagesAdapter.ImagesVH> {
    ...
    public TrainingModuleImagesAdapter(Activity activity, ArrayList<ModuleImage> arrImages) {
    ...
    public ImagesVH onCreateViewHolder(ViewGroup parent, int i) {
        ...
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.training_module_image_item, parent, false);
