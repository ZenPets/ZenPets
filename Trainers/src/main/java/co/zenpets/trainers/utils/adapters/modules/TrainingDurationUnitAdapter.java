...
public class TrainingDurationUnitAdapter extends ArrayAdapter<String> {
    ...
    public TrainingDurationUnitAdapter(Activity activity, int resource, List<String> arrSessions) {
