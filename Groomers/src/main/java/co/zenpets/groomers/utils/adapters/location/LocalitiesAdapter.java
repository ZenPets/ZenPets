package co.zenpets.groomers.utils.adapters.location;
...
import co.zenpets.groomers.utils.models.location.Locality;

public class LocalitiesAdapter extends ArrayAdapter<Locality> {
    ...
    private final ArrayList<Locality> arrLocalities;

    public LocalitiesAdapter(Activity activity, ArrayList<Locality> arrLocalities) {
