...
public class MainActivity extends AppCompatActivity {
    ...
    String SELECTED_CITY_NAME = null;
...
//        String[] strServes = getResources().getStringArray(R.array.cities);
//        final List<String> arrPrefix;
//        arrPrefix = Arrays.asList(strServes);
//        spnCities.setAdapter(new CitiesAdapter(
//                MainActivity.this,
//                R.layout.cities_row,
//                arrPrefix));
//
...
//                SELECTED_CITY_NAME = arrPrefix.get(position);
//            }
//
//            @Override
