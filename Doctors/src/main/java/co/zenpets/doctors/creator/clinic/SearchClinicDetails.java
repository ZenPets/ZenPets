...
public class SearchClinicDetails extends AppCompatActivity {
    ...
    @BindView(R.id.btnMap) AppCompatButton btnMap;

    /** MAP THIS DOCTOR TO THIS CLINIC **/
    @OnClick(R.id.btnMap) protected void mapDoctorClinic()  {
        new MaterialDialog.Builder(SearchClinicDetails.this)
                .icon(ContextCompat.getDrawable(SearchClinicDetails.this, R.drawable.ic_info_outline_black_24dp))
                .title("Add To Clinic")
                .cancelable(false)
                .content("To confirm that you practise at this Clinic, click the \"CONFIRM\" button. To cancel, click the \"CANCEL\" button. \n\nNote: After confirming, we will make your profile \"provisionally\" public. You will need to provide proof of you practising at this Clinic Within 7 days. We will verify the claim with the Doctor listed as the owner of the Clinic. If the verification fails, or, you fail to provide the details, your profile at this Clinic will become non-public and will not be available for the Zen Pets users.\n\nTo know the type of documents that can be submitted, please refer to the \"Help\" section in the side bar of the landing page.")
...
//    /** CLAIM THIS CLINIC **/
//    @OnClick(R.id.btnClaim) protected void claimClinic()    {
//    }

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.search_clinic_details);
    ...
    /***** MAP THE DOCTOR TO THE SELECTED CLINIC *****/
    private void mapTheDoctor() {
        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Mapping your profile to this Clinic...");
        ...
        call.enqueue(new Callback<ClinicMapper>() {
            ...
            public void onResponse(@NonNull Call<ClinicMapper> call, @NonNull Response<ClinicMapper> response) {
                if (response.isSuccessful())    {
                    ...
                    Intent showLanding = new Intent(SearchClinicDetails.this, LandingActivity.class);
            ...
            public void onResponse(@NonNull Call<Doctors> call, @NonNull Response<Doctors> response) {
                if (response.body() != null && response.body().getDoctors() != null)    {
                    ...
                    if (arrDoctors.size() > 0)  {
                        ...
                        listDoctors.setAdapter(new DoctorsAdapter(SearchClinicDetails.this, arrDoctors));
                    } else {
    ...
    private void getIncomingData() {
        ...
        if (bundle != null && bundle.containsKey("CLINIC_ID"))    {
            ...
            if (CLINIC_ID != null)  {
                ...
                fetchClinicDetails();
//                new FetchClinicDetails(this).execute(CLINIC_ID);
            } else {
    ...
    private void fetchClinicDetails() {
        ...
        call.enqueue(new Callback<ClinicData>() {
            ...
            public void onResponse(@NonNull Call<ClinicData> call, @NonNull Response<ClinicData> response) {
                ...
                Uri uriProfile = Uri.parse(DOCTOR_DISPLAY_PROFILE);
                imgvwDoctorProfile.setImageURI(uriProfile);
                ...
                clinicMap.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(GoogleMap googleMap) {
                        MapStyleOptions mapStyleOptions = MapStyleOptions.loadRawResourceStyle(SearchClinicDetails.this, R.raw.zen_map_style);
                ...
                /* HIDE OR SHOW THE "I PRACTISE HERE' BUTTON */
                if (LOGGED_IN_DOCTOR_ID.equalsIgnoreCase(DOCTOR_ID))    {
        ...
        call.enqueue(new Callback<ImagesData>() {
            ...
            public void onResponse(@NonNull Call<ImagesData> call, @NonNull Response<ImagesData> response) {
                ...
                if (arrImages != null && arrImages.size() > 0)  {
                    ...
                    listClinicImages.setAdapter(new ClinicImagesDetailsAdapter(SearchClinicDetails.this, arrImages));
                } else {
