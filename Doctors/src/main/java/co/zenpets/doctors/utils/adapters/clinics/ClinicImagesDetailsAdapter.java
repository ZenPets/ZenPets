...
public class ClinicImagesDetailsAdapter extends RecyclerView.Adapter<ClinicImagesDetailsAdapter.ImagesVH> {
    ...
    public ClinicImagesDetailsAdapter(Activity activity, ArrayList<ImageData> arrImages) {
    ...
    public ImagesVH onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.clinic_images_details_item, parent, false);
