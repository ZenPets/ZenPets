...
public class KennelMessagesAdapter extends RecyclerView.Adapter<KennelMessagesAdapter.MessagesVH> {
    ...
    public KennelMessagesAdapter(Activity activity, ArrayList<EnquiryMessage> arrMessages) {
    ...
    public void onBindViewHolder(final MessagesVH holder, final int position) {
        ...
        if (message.getKennelID() != null) {
            ...
            if (kennelName != null)    {
                holder.txtUserName.setText(kennelName);
            }
    ...
    public MessagesVH onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.kennel_enquiry_item, parent, false);
