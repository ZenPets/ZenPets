...
public class TestKennel {
    ...
    @SerializedName("kennelSmallCapacity") private String kennelSmallCapacity;
    @SerializedName("kennelMediumCapacity") private String kennelMediumCapacity;
    @SerializedName("kennelLargeCapacity") private String kennelLargeCapacity;
    @SerializedName("kennelXLargeCapacity") private String kennelXLargeCapacity;
    ...
    public String getKennelSmallCapacity() {
        return kennelSmallCapacity;
    }

    public void setKennelSmallCapacity(String kennelSmallCapacity) {
        this.kennelSmallCapacity = kennelSmallCapacity;
    }

    public String getKennelMediumCapacity() {
        return kennelMediumCapacity;
    }

    public void setKennelMediumCapacity(String kennelMediumCapacity) {
        this.kennelMediumCapacity = kennelMediumCapacity;
    }

    public String getKennelLargeCapacity() {
        return kennelLargeCapacity;
    }

    public void setKennelLargeCapacity(String kennelLargeCapacity) {
        this.kennelLargeCapacity = kennelLargeCapacity;
    }

    public String getKennelXLargeCapacity() {
        return kennelXLargeCapacity;
    }

    public void setKennelXLargeCapacity(String kennelXLargeCapacity) {
        this.kennelXLargeCapacity = kennelXLargeCapacity;
    }
