...
public class FilterRecordTypesAdapter extends BaseAdapter {
    ...
    private final ArrayList<RecordType> arrRecords;

    /** SELECTED ITEM POSITION **/
    private int selectedItem = -1;

    public FilterRecordTypesAdapter(Activity activity, ArrayList<RecordType> arrRecords) {
    ...
    public Object getItem(int position) {
        return arrRecords.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtProblemText.setText(arrRecords.get(position).getRecordTypeName());
