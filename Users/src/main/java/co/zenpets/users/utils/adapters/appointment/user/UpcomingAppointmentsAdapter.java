package co.zenpets.users.utils.adapters.appointment.user;
...
public class UpcomingAppointmentsAdapter extends RecyclerView.Adapter<UpcomingAppointmentsAdapter.AppointmentsVH> {
    ...
    public UpcomingAppointmentsAdapter(Activity activity, ArrayList<Appointment> arrAppointments) {
    ...
    public void onBindViewHolder(@NonNull final AppointmentsVH holder, int position) {
        ...
        try {
            ...
            holder.txtAppointmentDateAndTime.setText(strFormattedDate);
