package co.zenpets.users.utils.adapters.questions;
...
import co.zenpets.users.details.questions.QuestionDetails;
...
public class QuestionsAdapter extends RecyclerView.Adapter<QuestionsAdapter.ConsultationsVH> {
    ...
    public QuestionsAdapter(Activity activity, ArrayList<Consultation> arrConsultations) {
