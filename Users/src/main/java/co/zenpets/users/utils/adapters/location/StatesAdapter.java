package co.zenpets.users.utils.adapters.location;
...
public class StatesAdapter extends ArrayAdapter<State> {
    ...
    private final ArrayList<State> arrStates;

    public StatesAdapter(Activity activity, ArrayList<State> arrStates) {
