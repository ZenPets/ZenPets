package co.zenpets.users.utils.helpers.timings.tuesday;

//public class TuesdayMorningTimings extends AsyncTask<Object, Void, String[]> {
//
//    /** THE INTERFACE INSTANCE TO RETURN THE RESULTS TO THE CALLING ACTIVITY **/
//    private final TuesdayMorningTimingsInterface delegate;
//
...
//
//    public TuesdayMorningTimings(TuesdayMorningTimingsInterface delegate) {
//        this.delegate = delegate;
//    }
//
//    @Override
//    protected String[] doInBackground(Object... params) {
//        String TIMINGS_URL = AppPrefs.context().getString(R.string.url_timings_tue_mor);
...
//                if (JORoot.has("tueMorFrom"))    {
//                    MORNING_START_TIME = JORoot.getString("tueMorFrom");
//                } else {
//                    MORNING_START_TIME = null;
//                }
//
//                /* GET THE MORNING END TIME (TO) */
//                if (JORoot.has("tueMorTo"))  {
//                    MORNING_END_TIME = JORoot.getString("tueMorTo");
//                } else {
...
//        delegate.onTuesdayMorningResult(strings);
//    }
//}