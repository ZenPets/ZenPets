...
public class VaccinationImagesAdapter extends RecyclerView.Adapter<VaccinationImagesAdapter.ImagesVH> {

    /** THE ACTIVITY INSTANCE FOR USE IN THE ADAPTER **/
    private final Activity activity;

    /** ARRAY LIST TO GET DATA FROM THE ACTIVITY **/
    private final ArrayList<VaccinationImage> arrImages;

    public VaccinationImagesAdapter(Activity activity, ArrayList<VaccinationImage> arrImages) {
    ...
    public void onBindViewHolder(@NonNull final ImagesVH holder, int position) {
        ...
        if (data.getVaccinationImageURL() != null)  {
            Uri uri = Uri.parse(data.getVaccinationImageURL());
        ...
        holder.imgvwImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < arrImages.size(); i++) {
                    strings[i] = arrImages.get(i).getVaccinationImageURL();
                }
