package co.zenpets.users.utils.adapters.groomers.enquiry;
...
public class GroomerEnquiryAdapter extends RecyclerView.Adapter<GroomerEnquiryAdapter.MessagesVH> {
    ...
    public GroomerEnquiryAdapter(Activity activity, ArrayList<EnquiryMessage> arrMessages) {
