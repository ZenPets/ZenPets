...
public class Unit {
    ...
    @SerializedName("kennelInventoryPhoto") private String kennelInventoryPhoto;
    ...
    public String getKennelInventoryPhoto() {
        return kennelInventoryPhoto;
    }

    public void setKennelInventoryPhoto(String kennelInventoryPhoto) {
        this.kennelInventoryPhoto = kennelInventoryPhoto;
    }
