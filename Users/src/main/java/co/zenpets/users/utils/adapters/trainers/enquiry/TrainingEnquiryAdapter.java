package co.zenpets.users.utils.adapters.trainers.enquiry;
...
public class TrainingEnquiryAdapter extends RecyclerView.Adapter<TrainingEnquiryAdapter.MessagesVH> {
    ...
    public TrainingEnquiryAdapter(Activity activity, ArrayList<EnquiryMessage> arrMessages) {
