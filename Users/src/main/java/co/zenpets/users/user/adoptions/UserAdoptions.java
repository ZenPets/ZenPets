...
import co.zenpets.users.utils.adapters.adoptions.user.UserAdoptionsAdapter;
...
public class UserAdoptions extends AppCompatActivity {
    ...
    private void fetchUserAdoptions() {
        ...
        Call<Adoptions> call = api.listUserAdoptions(USER_ID);
        call.enqueue(new Callback<Adoptions>() {
            ...
            public void onResponse(Call<Adoptions> call, Response<Adoptions> response) {
                ...
                if (arrAdoptions.size() > 0)    {
                    ...
                    listAdoptions.setAdapter(new UserAdoptionsAdapter(UserAdoptions.this, arrAdoptions));
