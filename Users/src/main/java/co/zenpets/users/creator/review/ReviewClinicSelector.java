package co.zenpets.users.creator.review;
...
import co.zenpets.users.utils.models.clinics.ratings.ClinicRating;
import co.zenpets.users.utils.models.clinics.ratings.ClinicRatingsAPI;
...
public class ReviewClinicSelector extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.review_clinic_selector);
            ...
            public void onResponse(Call<Clinics> call, Response<Clinics> response) {
                if (response.body() != null && response.body().getClinics() != null)    {
                    ...
                    if (arrClinics.size() > 0)  {
                        ...
                        listClinics.setAdapter(new ClinicSelectorAdapter(ReviewClinicSelector.this, arrClinics));
                    } else {
...
//                    Log.e("RATINGS FAILURE", t.getMessage());
            ...
            holder.linlaClinicContainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intentNewFeedback.putExtra("CLINIC_ID", data.getClinicID());
