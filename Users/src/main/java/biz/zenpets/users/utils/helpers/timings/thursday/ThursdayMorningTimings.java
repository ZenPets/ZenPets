package biz.zenpets.users.utils.helpers.timings.thursday;

//public class ThursdayMorningTimings extends AsyncTask<Object, Void, String[]> {
//
//    /** THE INTERFACE INSTANCE TO RETURN THE RESULTS TO THE CALLING ACTIVITY **/
//    private final ThursdayMorningTimingsInterface delegate;
//
...
//
//    public ThursdayMorningTimings(ThursdayMorningTimingsInterface delegate) {
//        this.delegate = delegate;
//    }
//
//    @Override
//    protected String[] doInBackground(Object... params) {
//        String TIMINGS_URL = AppPrefs.context().getString(R.string.url_timings_thu_mor);
...
//                if (JORoot.has("thuMorFrom"))    {
//                    MORNING_START_TIME = JORoot.getString("thuMorFrom");
//                } else {
//                    MORNING_START_TIME = null;
//                }
//
//                /* GET THE MORNING END TIME (TO) */
//                if (JORoot.has("thuMorTo"))  {
//                    MORNING_END_TIME = JORoot.getString("thuMorTo");
//                } else {
...
//        delegate.onThursdayMorningResult(strings);
//    }
//}