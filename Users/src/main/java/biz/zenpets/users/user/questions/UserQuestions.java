package biz.zenpets.users.user.questions;
...
import biz.zenpets.users.user.questions.modules.MyPrivateQuestions;
import biz.zenpets.users.user.questions.modules.MyPublicQuestions;
...
public class UserQuestions extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_questions_container);
