...
import biz.zenpets.users.utils.adapters.kennels.NewTestKennelsAdapter;
...
public class TestKennelsList extends AppCompatActivity {
    ...
    private NewTestKennelsAdapter kennelsAdapter;
...
//            Log.e("EXCEPTION", e.getMessage());
    ...
    private void getUsersLocation() {
        ...
        if (ContextCompat.checkSelfPermission(TestKennelsList.this,
    ...
    private void fetchLocation() {
        Geocoder geocoder = new Geocoder(TestKennelsList.this, Locale.getDefault());
        try {
                ...
                if (city != null)   {
                    ...
                    if (FINAL_CITY_ID != null)  {
                        ...
                        new MaterialDialog.Builder(TestKennelsList.this)
                                ...
                                .positiveText("OKAY")
                                .theme(Theme.LIGHT)
                                .icon(ContextCompat.getDrawable(TestKennelsList.this, R.drawable.ic_info_outline_black_24dp))
                                .typeface("Roboto-Medium.ttf", "Roboto-Regular.ttf")
                                .show();
                    }
                } else {
