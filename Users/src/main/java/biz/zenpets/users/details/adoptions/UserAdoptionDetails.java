...
//                Log.e("TUESDAY FAILURE", t.getMessage());
    ...
    private void fetchAdoptionImages() {
        ...
        retrofit2.Call<AdoptionImages> call = api.fetchAdoptionImages(ADOPTION_ID);
        call.enqueue(new retrofit2.Callback<AdoptionImages>() {
            @Override
            public void onResponse(retrofit2.Call<AdoptionImages> call, retrofit2.Response<AdoptionImages> response) {
            ...
            @Override
            public void onFailure(retrofit2.Call<AdoptionImages> call, Throwable t) {
//                Log.e("TUESDAY FAILURE", t.getMessage());
                Crashlytics.logException(t);
            }
        });
