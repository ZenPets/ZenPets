...
//                        @Override
//                        public void onFailure(Call<ReviewVote> call, Throwable t) {
////                            Log.e("CHECdK VOTE FAILURE", t.getMessage());
//                            Crashlytics.logException(t);
//                        }
//                    });
//                }
...
//            View itemView = LayoutInflater.
//                    from(parent.getContext()).
//                    inflate(R.layout.doctor_reviews_item, parent, false);
//
//            return new ReviewsVH(itemView);
//        }
//
...
//            ReviewsVH(View v) {
//                super(v);
//                txtNameStart = itemView.findViewById(R.id.txtNameStart);
//                txtUserName = itemView.findViewById(R.id.txtUserName);
//                txtTimeStamp = itemView.findViewById(R.id.txtTimeStamp);
//                imgvwLikeStatus = itemView.findViewById(R.id.imgvwLikeStatus);
//                txtVisitReason = itemView.findViewById(R.id.txtVisitReason);
//                txtVisitExperience = itemView.findViewById(R.id.txtVisitExperience);
//                txtHelpfulNo = itemView.findViewById(R.id.txtHelpfulNo);
//                txtHelpfulYes = itemView.findViewById(R.id.txtHelpfulYes);
//            }
//        }
//    }
}